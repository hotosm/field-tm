...
const MapControlComponent = ({ map, pmTileLayerUrl }: mapControlComponentType) => {
  ...
  return (
    <div className="fmtm-absolute fmtm-bottom-24 md:fmtm-bottom-10 fmtm-right-3 fmtm-z-[45] fmtm-flex fmtm-flex-col fmtm-gap-3 fmtm-items-center">
      <LayerSwitchMenu map={map} pmTileLayerUrl={pmTileLayerUrl} />
      <div>
        <div className="fmtm-rounded fmtm-overflow-hidden fmtm-border">
          {btnList.map((btn) => (
            <Tooltip title={btn.title} placement="left" arrow key={btn.title}>
              <div
                className="fmtm-bg-white hover:fmtm-bg-gray-100 fmtm-cursor-pointer fmtm-duration-300 fmtm-w-7 fmtm-h-7 fmtm-flex fmtm-justify-center fmtm-items-center fmtm-border-t first:fmtm-border-white"
